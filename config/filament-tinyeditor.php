...
return [
    ...
    'profiles' => [
        ...
        'full' => [
            'plugins' => 'quickbars accordion autoresize codesample directionality advlist autolink link image editimage lists charmap preview anchor pagebreak searchreplace wordcount visualblocks visualchars code fullscreen insertdatetime media table emoticons help',
            'toolbar' => 'undo redo removeformat fontfamily fontsize  fontsizeinput font_size_formats styles | bold italic underline pagebreak | rtl ltr | alignjustify alignright aligncenter alignleft | numlist bullist outdent indent accordion | forecolor backcolor visualchars | blockquote table toc hr | image link anchor media codesample emoticons | visualblocks print preview wordcount fullscreen code help',
            'upload_directory' => null,
        ],
    ],
