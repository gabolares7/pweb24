...
<footer class="text-gray-600 body-font">
        ...
        <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                <image src="/storage/{{ setting("site_logo") }}" fill="none" stroke="currentColor" stroke-linecap="round"
                       stroke-linejoin="round" stroke-width="2" class="w-20 h-20 text-white p-2  rounded-full" viewBox="0 0 24 24">
                </image>
                <span class="ml-3 text-xl ">{{setting('site_name')}}</span>
            </a>
            <p class="mt-2 text-center text-gray-500">Construyendo un CMS</p>
        </div>
    ...
    <div class="bg-gray-100">
        ...
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-500 text-sm text-center sm:text-left">© 2024 Miguel Angel Quintana
            </p>
