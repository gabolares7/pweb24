@aware(['page'])
<footer style="background-color: rgb(252,157,6);" class="text-gray-600 body-font">
    <div class="container px-5 py-1 flex flex-wrap items-center mx-auto  ">
        <div class=" flex justify-start   mx-auto text-center flex-col">
            <a href="https://ulpgc.es" class="flex title-font font-medium items-center text-gray-900"">
            ...
            <p class=" text-gray-500 text-center"> PRÁCTICAS</p>
        </div>
        <!-- Enlaces del footer -->
        <div class="items-center  mt-10  text-center flex justify-between">
