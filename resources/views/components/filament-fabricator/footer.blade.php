@aware(['page'])
<footer style="background-color: #c7e6fc;" class="text-gray-600 body-font">
    <div class="container px-5 py-1 mx-auto flex items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div class="w-50 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a href="https://ulpgc.es" class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900"">
            ...
            <p class=" text-gray-500"> Construyendo un CMS</p>
        </div>
        <!-- Enlaces del footer -->
        <div class="flex-grow flex md:pl-10 mb-5 md:mt-0 mt-10 md:text-left text-center">
            ...
            <div class="lg:w-1/4 md:w-1/4 w-full px-4">
                <a href="#"> <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">PROTECCIÓN DE DATOS</h2>
                </a>
            </div>
            <div class="lg:w-1/4 md:w-1/4 w-full px-4">
                <a href="#"> <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">COOKIES</h2>
                </a>
            </div>
            <div class="lg:w-1/4 md:w-1/4 w-full px-4">
    ...
    <div class="bg-gray-100">
        ...
        <a class="ml-3 text-gray-500 hover:text-[#0073b1]" href="{{$vendorLink}}">
